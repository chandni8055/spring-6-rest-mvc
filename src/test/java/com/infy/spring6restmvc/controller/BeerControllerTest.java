...
import com.infy.spring6restmvc.service.BeerServiceImpl;
...
class BeerControllerTest {
    ...
    void testCreateNewBeer() throws Exception {
        ...
        given(beerService.savedNewBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null, false, 1, 25).getContent().get(1));
    ...
    void testCreateBeerNullBeerName() throws Exception {
        ...
        given(beerService.savedNewBeer(any(BeerDTO.class))).willReturn(beerServiceImpl
